...
1. Display names of students who belong to the same department as student ‘2310’.
SELECT Name
FROM Student
WHERE Dept_ID = (
    SELECT Dept_ID
    FROM Student
    WHERE Student_ID = '2310'
);

2. Display students who have the same gender as student ‘2306’.
...
WHERE Gender = (
    SELECT Gender
    FROM Student
    WHERE Student_ID = '2306'
);

3. Display students belonging to the same department as ‘23011’.
SELECT Name
FROM Student
WHERE Dept_ID = (
    SELECT Dept_ID
    FROM Student
    WHERE Student_ID = '23011'
);
...
16. Display students who are enrolled in the same course as student ‘2301’.
